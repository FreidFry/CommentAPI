...
namespace CommentAPI.Extencions.LoadModules
{
    public class ApiOptions : IApiOptions
    {
        ...
        public ApiOptions(IConfiguration config)
        {
            ...
            ImagePublicUrl =        config["S3:image:ServiceUrl"] ?? throw new ArgumentNullException("S3__Image__PublicUrl");
            ...
            txtPublicUrl =          config["S3:txt:ServiceUrl"] ?? throw new ArgumentNullException("S3__txt__PublicUrl");
